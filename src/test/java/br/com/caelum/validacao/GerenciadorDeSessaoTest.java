package br.com.caelum.validacao;
...
public class GerenciadorDeSessaoTest {
	...
	public void preparaSessoes() {
		...
		this.sessaoDasTreze = new Sessao(LocalTime.parse("10:00:00"), rogueOne, sala3D);
		this.sessaoDasDezoito = new Sessao(LocalTime.parse("10:00:00"), rogueOne, sala3D);
	}
